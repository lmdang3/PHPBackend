                            ...
                            <div class="lg:flex lg:flex-wrap g-0">
                                <div class="lg:w-6/12 px-4 md:px-0">
                                    <div class="md:p-12 md:mx-6">
                                        <div class="text-center">
                                            <img src="{{asset('assets/images/Meridian.jpg')}}"
                                ...
                                <div
                                    ...
                                    <div class="text-black px-4 py-6 md:p-12 md:mx-6">
                                        ...
                                        <p class="text-sm">
                                            Meridian Brands was formed in 2021 when it assumed ownership of HMS
                                            Productions LLC, a longtime industry leader in the design, sourcing,
                                            manufacturing, and distribution of branded and private label women's
                                            apparel.
                                        </p>
                                    </div>
                                </div>
